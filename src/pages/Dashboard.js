    ...
    return (
        <div className="dashboard-main">
            ...
            <div className="dashboard-card greeting-card">
                {/*<p className="greeting-text">안녕하세요, {userName}님.</p>*/}
                <p className="greeting-text">안녕하세요, 홍길동님.</p>
                <p className="greeting-subtext">오늘도 냠잇과 함께 건강한 하루 보냅시다~</p>
            </div>

            {/* Meal Recommendation + Fasting Status */}
            <div className="dashboard-section">
                    <Link to= "/recipes" className="dashboard-card meal-card">
                        <h2>오늘의 식단 추천</h2>
                        <p>길동님을 위한 건강식단 입니다!</p>
                ...
                <div className="dashboard-card fasting-card">
                    ...
                    <p>간헐적 단식(16:8)을 시작한 지 5일째입니다.<br />
                        지금은 '지방 연소' 구간에 진입했어요!</p>
                </div>
            </div>
            ...
            <div className="dashboard-card info-card">
                <Link to="/" className="info-card">
                    <h3>단식이 왜 몸에 좋을까요?</h3>
                    <p>단식은 인슐린 민감도를 개선하고, 세포의 자가포식(Autophagy)을 촉진하여 노화 방지 및 체중 관리에 도움을 줍니다.</p>
                </Link>
            </div>
